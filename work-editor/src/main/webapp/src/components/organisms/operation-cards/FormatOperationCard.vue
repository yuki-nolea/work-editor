      ...
      <div class="operation-view-item-desc">
        <div class="operation-desc">
          <table class="operation-table">
            ...
            <tr>
              <td><p><strong>Chart type:</strong></p></td>
              <td>{{fmtDataType}}</td>
            </tr>
            <tr>
...
export default defineComponent({
  ...
  setup: (props) =>
  {
    ...
    const fmtData = computed(() => operation.value.getArgs().get("fmtData"));
    ...
    [
      ...
      {name: "Raw", type: FormatType.Raw},
    ];

    const fmtDataType = computed(() => fmtTypeList.find(item => item.type === fmtData.value.fmtType)!.name);


    return { outputVariable, fmtData, fmtDataType, deleteOperation };
  },
});
</script>
